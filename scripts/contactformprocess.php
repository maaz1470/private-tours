...
/* Gathering Data Variable */	
	...
	$otheremailField = $_POST['otheremail'];
...
Other Email: $otheremailField <br>
...
<div class="header">               
    ...
    <div class="container"> 
        ...
        <div align="center" >                                             
            ...
            <a href="https://privatetoursofvenice.com"><img id="logo-header" src="../assets/img/privatetourslogo.png" alt="Logo"></a>
