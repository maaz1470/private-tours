...
/* Subject and Email Variables */
	...
	$webMaster = 'info@privatetoursofvenice.com';
...
/* Gathering Data Variable */	
	...
	$termsagreedField = $_POST['termsagreed'];
	
	$pubblicationagreedField = $_POST['pubblicationagreed'];
...
Terms and Conditions Read: $termsagreedField <br>

Media Pubblication  Agreed: $pubblicationagreedField <br>
...
<div class="header">               
    ...
    <div class="container"> 
        ...
        <div align="center" >                                             
            ...
            <a href="https://privatetoursofvenice.com"><img loading="lazy" id="logo-header" src="../img/webp/privatetourslogo.webp" alt="Logo"></a>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-66070595-1"></script>
<script>
